...
function Home() {
  ...
  const getBuses = async () => {
    const tempFilters = { status: "Yet To Start" };
    ...
    const queryParams = new URLSearchParams(tempFilters).toString();
  
    try {
      dispatch(ShowLoading());
      const response = await axios.get(`/api/buses/get-all-buses?${queryParams}`, {
        headers: {
